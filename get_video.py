...
def get_video_frames(src, fpv, frame_height, frame_width):
    ...
    # Needed for Densenet121-2d
    rnd_frame = cv2.resize(rnd_frame, (224, 224))
...
def get_video_and_label(
        index, data, frames_per_video, frame_height, frame_width):
    ...
    frame, clip = get_video_frames(os.path.join(
        ...
        frames_per_video, frame_height, frame_width)
...
def video_gen(
        data, frames_per_video, frame_height, frame_width, channels,
    ...
    while True:
        ...
        for batch in range(0, len(indices_arr), batch_size):
            ...
            clip = np.empty([0, frames_per_video, frame_height, frame_width,
